...
@Command(name = "riotx", versionProvider = Versions.class, subcommands = { DatabaseExport.class, DatabaseImport.class,
		FakerImport.class, FileExport.class, FileImportX.class, Generate.class, Ping.class, ReplicateX.class,
		Compare.class, GenerateCompletion.class, RedisImportCommand.class, StreamImport.class, StreamExport.class,
		MemcachedReplicate.class,
		SnowflakeImport.class }, description = "RIOT extension for the Enterprise.", footerHeading = "%nRun 'riotx COMMAND --help' for more information on a command.%n%nFor more help on how to use RIOT-X, head to https://redis-field-engineering.github.io/riotx%n")
