...
----
{app} replicate [OPTIONS] SOURCE TARGET
----
...
For example `{app} replicate redis://source:6379/1 redis://target:6379` replicates database `1`.
...
[source,console,subs="verbatim,attributes"]
----
{app} compare SOURCE TARGET [OPTIONS]
----
