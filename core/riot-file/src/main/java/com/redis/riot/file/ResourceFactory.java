...
public class ResourceFactory {
    ...
    private final Set<ProtocolResolver> protocolResolvers = new HashSet<>();
    ...
    private Resource createResource(String location, FileOptions options) throws IOException {
        ...
        GoogleStorageProtocolResolver resolver = resourceLoader.getGoogleStorageProtocolResolver();
        resolver.setStorage(options.getGoogleStorageOptions().storage());
