...
public class Step<I, O> {
    ...
    private Callable<Long> maxItemCountSupplier = () -> null;
    ...
    public Long maxItemCount() throws Exception {
        return maxItemCountSupplier.call();
    }
    ...
    public Callable<Long> getMaxItemCountSupplier() {
        return maxItemCountSupplier;
    }

    public Step<I, O> maxItemCountSupplier(Callable<Long> supplier) {
    ...
    public Step<I, O> maxItemCount(int count) {
        return maxItemCountSupplier(() -> (long) count);
    }
